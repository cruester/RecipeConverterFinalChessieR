/* This program allows the user to convert ingredient
** amounts in a recipe based on how much of the recipe
** he or she wishes to make. Users may also calculate
** nutrition info based on the number of servings they
** select. */
